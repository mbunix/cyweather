                  ...
                  <TabPanel>
                    <ul>
                      <li>
                        ...
                        <span>
                          Min {Math.round(item.temperatureLow)} ° / Max{" "}
                          {Math.round(item.temperatureHigh)} °
                        </span>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <span>{format(fromUnixTime(item.sunriseTime), "h:m a")}</span>
                      </li>
                      <li>
                        <strong>Sunset</strong>{" "}
                        <span>{format(fromUnixTime(item.sunsetTime), "h:m a")}</span>
                      </li>
                      <li>
                                  ...
                                  if (
                                    ...
                                    return (
                                      <tr key={hour.time}>
                                        ...
                                        <td>{Math.round(hour.temperature)} °</td>
                                        <td>{formatAsPercentage(hour.precipProbability)}</td>
                                        <td>
                                          {getDirection(item.windBearing)}{" "}
